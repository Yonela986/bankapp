...
#from Register import RegForm
import bcrypt # type: ignore

class LoginPage(tk.Tk):
    def __init__(self):
        super().__init__()
        self.configure(background="light blue")  # Set background color for the root window
    ...
    def show_registration_page(self, event):
        ...
        # Create and display registration form
        self.registration_form = RegForm(self.main_frame)
        ...
        self.create_password_button = tk.Button(self, text="Create Password", command=self.create_password)
        self.create_password_button.grid(row=2, column=1, padx=5, pady=5)


        # Generate password button
        self.generate_password_button = tk.Button(self, text="Generate Password", command=self.generate_random_password)
